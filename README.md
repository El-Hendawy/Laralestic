<p align="center">
<!-- <a href="https://travis-ci.org/el-hendawy/laralestic"><img src="https://travis-ci.org/el-hendawy/laralestic.svg?branch=master" alt="Build Status"></a> -->
<a href="https://packagist.org/packages/el-hendawy/laralestic"><img src="https://poser.pugx.org/el-hendawy/laralestic/v/stable.svg" alt="Latest Stable Version"></a>
<a href="https://packagist.org/packages/el-hendawy/laralestic"><img src="https://poser.pugx.org/el-hendawy/laralestic/d/total.svg" alt="Total Downloads"></a>
<a href="https://packagist.org/packages/el-hendawy/laralestic"><img src="https://poser.pugx.org/el-hendawy/laralestic/license.svg" alt="License"></a>
</p>
...
- Can be used as a [laravel scout](https://laravel.com/docs/9.0/scout) driver.
...
- Caching queries using a caching layer over query builder built on [laravel cache](https://laravel.com/docs/9.0/cache).

## Requirements

- `php` >= 7.2 
  
  See [Travis CI Builds](https://travis-ci.org/el-hendawy/laralestic).

- `laravel/laravel` >= 8.* or `laravel/lumen` >= 8.* or `composer application`
...
## Releases
  ...
  See [Change Log](https://github.com/El-Hendawy/Laralestic/blob/main/CHANGELOG.md).

## Author
[El-Hendawy](https://www.linkedin.com/in/omarelhendawy/) - [omar.el.hendawy@outlook.com](mailto:omar.el.hendawy@outlook.com) 

## Bugs, Suggestions and Contributions

Please use [Github](https://github.com/El-Hendawy/Laralestic) for reporting bugs, 
